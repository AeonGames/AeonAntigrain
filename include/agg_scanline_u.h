...
namespace agg
{
    ...
    {
    public:
        using base_type = scanline_u8          ;
        using alpha_mask_type = AlphaMask            ;
        using cover_type = base_type::cover_type;
