...
namespace agg
{
    ...
    public:
        ...
        using gray8_adaptor_type = font_engine_win32_tt_base::gray8_adaptor_type;
        using mono_adaptor_type = font_engine_win32_tt_base::mono_adaptor_type ;
        using scanlines_aa_type = font_engine_win32_tt_base::scanlines_aa_type ;
        using scanlines_bin_type = font_engine_win32_tt_base::scanlines_bin_type;
